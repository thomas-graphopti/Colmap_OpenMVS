            ...
            commands.append(
                {
                    ...
                    "command": [
                        ...
                        os.path.join(colmap_working_folder),
                        "--output-file",
                        os.path.join(colmap_working_folder, "model_dense_mesh.mvs"),
                    ]
                    + reconstructMeshOptions,
                }
            )
                ...
                commands.append(
                    {
                        ...
                        "command": [
                            ...
                            "--output-file",
                            os.path.join(
                                colmap_working_folder, "model_dense_mesh_refine.mvs"
                            ),
                        ]
                        + refineMeshOptions,
                    }
...
def runCommands(commands):
    ...
    for instruction in commands:
        ...
        commands_time_cost[instruction["title"]] = command_end_time - command_start_time
    ...
    print(
        "\n\nFinished without errors (I guess) - Time used:: {0} seconds".format(
            (hours * 60 * 60) + (minutes * 60) + seconds
        )
    )
    print(commands_time_cost)
